...
void _sessionSerialize(
  ...
  writer.writeBool(offsets[0], object.isSession);
...
Session _sessionDeserialize(
  ...
  final object = Session(
    id: id,
    isSession: reader.readBool(offsets[0]),
...
extension SessionQueryFilter
  ...
  QueryBuilder<Session, Session, QAfterFilterCondition> isSessionEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isSession',
        value: value,
      ));
    });
  }
...
extension SessionQuerySortBy on QueryBuilder<Session, Session, QSortBy> {
  QueryBuilder<Session, Session, QAfterSortBy> sortByIsSession() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSession', Sort.asc);
    });
  }

  QueryBuilder<Session, Session, QAfterSortBy> sortByIsSessionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSession', Sort.desc);
    });
  }
...
extension SessionQuerySortThenBy
  ...
  QueryBuilder<Session, Session, QAfterSortBy> thenByIsSession() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSession', Sort.asc);
    });
  }

  QueryBuilder<Session, Session, QAfterSortBy> thenByIsSessionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isSession', Sort.desc);
    });
  }
...
extension SessionQueryWhereDistinct
  ...
  QueryBuilder<Session, Session, QDistinct> distinctByIsSession() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isSession');
    });
  }
...
extension SessionQueryProperty
  ...
  QueryBuilder<Session, bool, QQueryOperations> isSessionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isSession');
    });
  }

  QueryBuilder<Session, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
